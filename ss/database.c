 ...
 */
int
init_database(ss_env *env, const char *db_path)
{
  int rc;
 ...
 */
int
db_get_token_id(const ss_env *env,
 ...
 */
int
db_update_postings(const ss_env *env, int token_id, int docs_count,
